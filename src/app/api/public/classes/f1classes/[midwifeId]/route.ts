...
export async function GET(
    ...
    try {
        ...
        const midwifeClasses = await f1ClassesModel.findOne({
            midwifeId: midwifeId
        })
...
export async function PUT(
    ...
    try {
        ...
        const existingClasses = await f1ClassesModel.findOne({
            midwifeId: midwifeId
        })
        ...
        // Update the document
        const updatedClasses = await f1ClassesModel.findOneAndUpdate(
            { midwifeId: midwifeId },
            {
