...
const e1ClassesSchema = new mongoose.Schema({
    midwifeId: {
        type: mongoose.Schema.Types.ObjectId,
        // ref: "Users", // Uncomment when you have the Users model
        required: true,
...
e1ClassesSchema.pre('save', function (next) {
    this.updatedAt = new Date();
    next();
});

// Add indexes for better query performance
// e1ClassesSchema.index({ midwifeId: 1 });

const e1ClassesModel =
    mongoose.models.e1Classes ||
    mongoose.model("e1Classes", e1ClassesSchema);

export default e1ClassesModel;
